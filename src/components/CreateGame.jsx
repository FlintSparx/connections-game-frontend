...
function CreateGame() {
  ...
  const handleFormSubmit = async (formData) => {
    ...
    const gameData = {
      ...
      category1: { name: formData.category1.name, words: formData.category1.word },
      category2: { name: formData.category2.name, words: formData.category2.word },
      category3: { name: formData.category3.name, words: formData.category3.word },
      category4: { name: formData.category4.name, words: formData.category4.word },
    };
